...
import CommentModal from "../../molecules/A_Shared/CommentModal";
import "./a_styles/CommentIcon.css";
...
function CommentIcon(props) {
  ...
  let commentIconColor = "var(--lynch)";
  let commentIconBgColor = "var(--transpar)";
  let callOnMouseEnter = props.onMouseEnter || function () {};
  let callOnMouseLeave = props.onMouseLeave || function () {};
  let openCommentDisplay = "inline";
  let closedCommentDisplay = "none";
  if (props.hover) {
    commentIconColor = "var(--dodger-blue)";
    commentIconBgColor = "rgba(29, 161, 242, 0.1)";
  }
  return (
    <>
      <div
        ...
        style={{ backgroundColor: commentIconBgColor }}
      >
        <svg
          className="open-comment-icon"
          style={{ fill: commentIconColor, display: openCommentDisplay }}
        ...
        <svg
          className="closed-comment-icon"
          style={{ display: closedCommentDisplay }}
